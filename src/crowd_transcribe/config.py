...
class Config:
    ...
    s3_bucket_vtt: str = field(default_factory=lambda: os.getenv("S3_BUCKET_VTT", ""))
    s3_bucket_mp3: str = field(default_factory=lambda: os.getenv("S3_BUCKET_MP3", "portal-daf-yomi-audio"))
    ...
    task_expiration_minutes: int = field(default_factory=lambda: int(os.getenv("TASK_EXPIRATION_MINUTES", "120")))
